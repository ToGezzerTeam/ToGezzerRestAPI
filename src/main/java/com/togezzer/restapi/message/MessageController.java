...
public class MessageController {
    ...
    public void createMessage(@PathVariable @NotNull(message = "Room's UUID is required") UUID roomUuid,
                              @Valid @RequestBody CreateMessageDTO createMessageDTO) {
        this.messageService.createMessage(roomUuid, createMessageDTO);
    }
    ...
    public MessagesPageResponseDto getMessages(
        ...
        return this.messageService.getMessages(roomUuid, lastMessageUuid, pageSize);
    }
}